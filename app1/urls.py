...
urlpatterns = [
    # 1. لوحة التحكم والإدارة الشاملة للفعالية (عرض + إضافة)
    path('event/<int:event_id>/dashboard/', views.event_control_dashboard, name='event_control_dashboard'),
    path('event/<int:event_id>/scanner/', views.live_camera_scanner, name='live_camera_scanner'),
