...
> نظام متكامل وذكي لإدارة الحضور والتذاكر للفعاليات، يعتمد على المسح الفوري لأكواد QR، التحديثات اللحظية، والطباعة الحرارية والتفاعل مع WhatsApp.

---

## 📖 نبذة عن المشروع
**EventHub** هو تطبيق ويب مبني باستخدام Django لإدارة البوابات وتنظيم الحضور في الفعاليات. يتيح للمنظمين مسح تذاكر الـ QR بسرعة، المزامنة اللحظية لحالة الحاضرين (بالداخل / بالخارج)، إدارة وتعديل السجلات، وتصدير واستيراد البيانات بكل سهولة.
...
### Frontend
* **HTML5 / CSS3** (تصميم داكن نيون - Cyberpunk Theme)
* **JavaScript (Vanilla JS / Fetch API)** للتحديثات اللحظية
* **FontAwesome 6.5** للأيقونات
* **Google Cairo Font**

---

## 📂 هيكلية المشروع الحقيقية (Project Structure)
...
# إنشاء وتفعيل البيئة الافتراضية (اختياري)
python -m venv venv
# Windows:
...
> قم بفتح المتصفح وانتقل إلى: `http://127.0.0.1:8000/`
...
| `/attendee/import/` | استيراد ملفات Excel/CSV القادمة من الواجهة |
